package com.kp.stockmarketcode.fragments.ProfitLoss
...
class ProfitLossFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        *//*reportViewModel.text.observe(viewLifecycleOwner, Observer {
        ...
        view.rvList.adapter = ProfitLossAdapter(profitLoss)*/
...
//            tvToDate.setError(getString(R.string.select_to_date))
    ...
    companion object {
        @JvmStatic
        fun newInstance(sectionNumber: Int): ProfitLossFragment {
            return ProfitLossFragment().apply {
